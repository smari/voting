...
MEASURES = {
    ...
    "loosemore_hanby": "Proportionality index according to Loosemore-Hanby (using the chosen fair shares)",
    "sainte_lague":    "Scaled sum of squared deviation of list seats from fair seat shares (Sainte-Lague)",
    "dhondt_min":      "Mininum seat value used (d'Hondt)",
    "dhondt_sum":      "Scaled sum of positive deviation of list seats from fair seat shares (d'Hondt)",
}
DEVIATION_MEASURES = [
    "dev_opt",
    "dev_law",
